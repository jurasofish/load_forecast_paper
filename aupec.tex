...
The forecasting system was provided with load profiles with similar exogenous data to the profile being forecast.
\par
...
\par
Similar days were selected from both the past and the future, as the training data for the system is only five years.
