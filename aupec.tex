...
\begin{figure}[htbp]
	...
	\caption{The forecaster was able to predict the major peak (top, 21 July 18:00), enabling the batteries, rather than the generator, to support the island (bottom).}
	\label{fig:bruny_nac}
\end{figure}
