...
Given an input $\boldsymbol{X}$ of dimension $T \times d$, the output $\boldsymbol{Y}$ is populated by $\boldsymbol{Y}_{i,*} = $ max$(0, boldsymbol{i,*}  \boldsymbol{W}_1 + \boldsymbol{b}_1)  \boldsymbol{W}_2 + \boldsymbol{b}_2$ with $\boldsymbol{Y}$ having the same dimensions as $\boldsymbol{X}$.
