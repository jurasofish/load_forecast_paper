...
More specifically, given a learned kernel $\boldsymbol{K}$ of dimension $N \times d$, the embedded representation is given by $\boldsymbol{X}'_{i, j} = \boldsymbol{X}_{i,*} \cdot \boldsymbol{K}_{*, j}$.
